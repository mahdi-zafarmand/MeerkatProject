 ...
 * @param <E>
 */
public class Hub<V extends IVertex,E extends IEdge<V>> 
                                                extends IMetric<V,E> {
    static HITS hitsAlg;
...
//            } else {
        ...
        if (hitsAlg != null) {
            ...
            hitsAlg.setType(HITS.Type.Hub);
        }
        return hitsAlg;
    }

    private Hub(IDynamicGraph<V, E> pIGraph, TimeFrame tf, String[] parameters) {
        super(pIGraph, tf, parameters);
        this.metricAttribute=MeerkatSystem.HUB;
    }
