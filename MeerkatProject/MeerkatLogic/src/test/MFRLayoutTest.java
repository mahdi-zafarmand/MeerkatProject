...
import algorithm.graph.layout.algorithms.ModifiedFRLayout;
...
public class MFRLayoutTest {
    ...
    public static void layoutGraph(IDynamicGraph<IVertex,IEdge<IVertex>> dynaGraph) {
        ...
        for (TimeFrame t : dynaGraph.getAllTimeFrames()) {
            ...
            parameters[0] = "COMC";
            ModifiedFRLayout mfrlLayout = new ModifiedFRLayout(dynaGraph, t, parameters);
