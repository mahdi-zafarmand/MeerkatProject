    ...
    */
    public static boolean SaveAsPNG (AnalysisController pController) {
        ...
        try {
            ...
            //setting the viewport area for the snapshot
            Rectangle2D viewport = new Rectangle2D(0, 0,SceneConfig.GRAPHCANVAS_VIEWPORT_WIDTH,SceneConfig.GRAPHCANVAS_VIEWPORT_WIDTH);
            ...
            pController.updateStatusBar(false, StatusMsgsConfig.SNAPSHOT_CURRENTVIEW);
        } catch (IOException e) {
