 ...
 * 
*/
public class MenuItemLocalT extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemLocalT()
     *  Created Date    : 2016-04-12
     ...
     * 
    */
    public MenuItemLocalT(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        LocalT.Display(pController, pobjParameter.toString());                
    }
}