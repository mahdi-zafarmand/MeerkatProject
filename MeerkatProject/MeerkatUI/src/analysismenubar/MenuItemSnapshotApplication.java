...
/**
 *  Class Name      : MenuItemSnapshotApplication
 ...
 * 
*/
public class MenuItemSnapshotApplication extends MenuItemGeneric implements IMenuItem {
     ...
     * 
    */
    public MenuItemSnapshotApplication(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        try {
            ...
            boolean blnIsSucess = ApplicationSnapshot.SaveAsPNG(pController) ;
