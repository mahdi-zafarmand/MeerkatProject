 ...
 * @since 2018-05-25
 */
public class MenuItemModeDeleteVertices extends MenuItemGeneric implements IMenuItem {
     ...
     * @since 2018-05-25
     */
    public MenuItemModeDeleteVertices(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        UIInstance.getActiveProjectTab().getActiveGraphTab().setGraphCanvasMode(ModeConfig.ModeTypes.VERTEXDELETE);
    }
}