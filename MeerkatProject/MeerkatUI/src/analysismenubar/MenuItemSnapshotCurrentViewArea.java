...
/**
 *  Class Name      : MenuItemSnapshotCurrentViewArea
 ...
 * 
*/
public class MenuItemSnapshotCurrentViewArea extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemSnapshotApplication()
     *  Created Date    : 2016-03-21
     ...
     * 
    */
    public MenuItemSnapshotCurrentViewArea(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        try {
            ...
            boolean blnIsSucess = VisibleGraphArea.SaveAsPNG(pController) ;
