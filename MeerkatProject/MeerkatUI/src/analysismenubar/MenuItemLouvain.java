 ...
 * 
*/
public class MenuItemLouvain extends MenuItemGeneric implements IMenuItem {
     ...
     * 
    */
    public MenuItemLouvain(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        Louvain.Display(pController, pobjParameter.toString());                
    }
}