...
/**
 *  Class Name      : MenuItemDeleteAllVertices
 *  Created Date    : 2017-07-24
 *  Description     : Functionalities when the user chooses to delete all vertices from the menu
 *  Version         : 1.0
 *  @author         : sankalp
 * 
 ...
 * 
*/
public class MenuItemDeleteAllVertices extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemDeleteAllVertices()
     ...
     * 
    */
    public MenuItemDeleteAllVertices(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
     ...
     *  Method Name     : Click
     *  Created Date    : 2017-07-24
     *  Description     : call the method to delete all the vertices.
     *  Version         : 1.0
     *  @author         : sankalp
     * 
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        MeerkatUI.getUIInstance().getActiveProjectTab().getActiveGraphTab().getGraphCanvas().selectAllVertices();
