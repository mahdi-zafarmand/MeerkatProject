...
/**
 *  Class Name      : MenuItemDeleteSelectedEdges
 *  Created Date    : 2017-07-24
 *  Description     : Functionalities when the user chooses to delete selected edges from the menu
 *  Version         : 1.0
 *  @author         : sankalp
 * 
 ...
 * 
*/
public class MenuItemDeleteSelectedEdges extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemDeleteSelectedEdges()
     ...
     * 
    */
    public MenuItemDeleteSelectedEdges(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
     ...
     *  Method Name     : Click
     *  Created Date    : 2017-07-24
     *  Description     : call the method to delete selected edges.
     *  Version         : 1.0
     *  @author         : sankalp
     * 
