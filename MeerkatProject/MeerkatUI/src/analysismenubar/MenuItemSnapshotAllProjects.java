...
/**
 *  Class Name      : MenuItemSnapshotAllProjects
 ...
 * 
*/
public class MenuItemSnapshotAllProjects extends MenuItemGeneric implements IMenuItem {
     ...
     * 
    */
    public MenuItemSnapshotAllProjects(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        try {
            ...
            boolean blnIsSucess = AllProjectsAllGraphs.SaveAsPNG(pController) ;
