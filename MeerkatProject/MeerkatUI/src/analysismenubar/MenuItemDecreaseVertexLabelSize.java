 ...
 * 
*/
public class MenuItemDecreaseVertexLabelSize extends MenuItemGeneric implements IMenuItem {
        
    /**
     *  Constructor Name: MenuItemDecreaseVertexLabelSize()
     *  Created Date    : 2016-05-26
     ...
     * 
    */
    public MenuItemDecreaseVertexLabelSize(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        UIInstance.getActiveProjectTab().getActiveGraphTab().decreaseVertexLabel();
    }
}
