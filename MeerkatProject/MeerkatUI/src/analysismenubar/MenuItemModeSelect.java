 ...
 * @since 2018-05-25
 */
public class MenuItemModeSelect extends MenuItemGeneric implements IMenuItem {
     ...
     * @since 2018-05-25
     */
    public MenuItemModeSelect(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        EditingToolBox.getInstance().activateSelectionMode();
        UIInstance.getActiveProjectTab().getActiveGraphTab().setGraphCanvasMode(ModeConfig.ModeTypes.SELECT);
    }
}