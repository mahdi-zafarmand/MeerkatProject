...
/**
 *  Class Name      : MenuItemUnpinVertices
 ...
 * 
*/
public class MenuItemUnpinVertices extends MenuItemGeneric implements IMenuItem {
     ...
     * 
    */
    public MenuItemUnpinVertices(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        pController.updateStatusBar(true, StatusMsgsConfig.VERTEXPINNING_DISABLING);
        UIInstance.getActiveProjectTab().getActiveGraphTab().unpinVertexToCanvas();
        pController.updateStatusBar(false, StatusMsgsConfig.VERTEXPINNING_DISABLED);
