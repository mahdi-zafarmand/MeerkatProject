...
/**
 *  Class Name      : MenuItemEnableVisualization
 ...
 * 
*/
public class MenuItemEnableVisualization extends MenuItemGeneric implements IMenuItem {
            
    /**
     *  Constructor Name: MenuItemEnableVisualization()
     *  Created Date    : 2016-08-08
     ...
     * 
    */
    public MenuItemEnableVisualization(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        UIInstance.getActiveProjectTab().getActiveGraphTab().enableVisualization();
        pController.updateStatusBar(false, StatusMsgsConfig.CANVAS_VISUALIZATION_ENABLED);
    }
}