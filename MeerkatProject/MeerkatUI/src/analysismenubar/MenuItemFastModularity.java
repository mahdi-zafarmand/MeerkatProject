...
/**
 *  Class Name      : MenuItemFastModularity
 ...
 * 
*/
public class MenuItemFastModularity extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemFastModularity()
     *  Created Date    : 2016-04-12
     ...
     * 
    */
    public MenuItemFastModularity(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        FastModularity.Display(pController, pobjParameter.toString());                
    }
}