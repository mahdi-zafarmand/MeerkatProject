...
/**
 *  Class Name      : MenuItemSnapshotCurrentProject
 ...
 * 
*/
public class MenuItemSnapshotCurrentProject extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemSnapshotCurrentProject()
     *  Created Date    : 2016-03-21
     ...
     * 
    */
    public MenuItemSnapshotCurrentProject(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        try {
            ...
            boolean blnIsSucess = CurrentProjectAllGraphs.SaveAsPNG(pController) ;
