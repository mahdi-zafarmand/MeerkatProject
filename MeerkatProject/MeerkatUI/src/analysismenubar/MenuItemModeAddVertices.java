 ...
 * @since 2018-05-25
 */
public class MenuItemModeAddVertices extends MenuItemGeneric implements IMenuItem {
     ...
     * @since 2018-05-25
     */
    public MenuItemModeAddVertices(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        EditingToolBox.getInstance().activateAddVertex();
        UIInstance.getActiveProjectTab().getActiveGraphTab().setGraphCanvasMode(ModeConfig.ModeTypes.VERTEXADD);
    }
}