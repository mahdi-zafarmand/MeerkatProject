...
/**
 *  Class Name      : MenuItemLocalCommunity
 *  Created Date    : 2016-04-12
 *  Description     : Functionalities when the user chooses Local Community Mining Algorithm from the MenuBar
 *  Version         : 1.0
 *  @author         : Talat
 * 
 ...
 * 
*/
public class MenuItemLocalCommunity extends MenuItemGeneric implements IMenuItem {

    /**
     *  Constructor Name: MenuItemLocalCommunity()
     *  Created Date    : 2016-04-12
     ...
     * 
    */
    public MenuItemLocalCommunity(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    */
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        LocalCommunity.Display(pController, pobjParameter.toString());                
    }
}