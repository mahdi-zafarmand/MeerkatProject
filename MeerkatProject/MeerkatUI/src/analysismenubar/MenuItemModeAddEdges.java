 ...
 * @since 2018-05-25
 */
public class MenuItemModeAddEdges extends MenuItemGeneric implements IMenuItem {
     ...
     * @since 2018-05-25
     */
    public MenuItemModeAddEdges(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        EditingToolBox.getInstance().activateAddEdge();
        UIInstance.getActiveProjectTab().getActiveGraphTab().setGraphCanvasMode(ModeConfig.ModeTypes.EDGEADD);
    }
}