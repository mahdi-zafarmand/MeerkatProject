 ...
 * @since 2018-05-25
 */
public class MenuItemModeDeleteEdges extends MenuItemGeneric implements IMenuItem {
     ...
     * @since 2018-05-25
     */
    public MenuItemModeDeleteEdges(String pstrMenuItemDisplay, String pstrMenuItemClass, String pstrMenuItemIconPath) {
    ...
    public void Click(AnalysisController pController, MenuItem pMenuItem, Object pobjParameter) {
        ...
        EditingToolBox.getInstance().activateDeleteEdge();
        UIInstance.getActiveProjectTab().getActiveGraphTab().setGraphCanvasMode(ModeConfig.ModeTypes.EDGEDELETE);
    }
}