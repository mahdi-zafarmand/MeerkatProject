...
public class ArrowLine extends Line implements IEdgeShapes {
    ...
    public ArrowLine (
        ...
        double angle = Math.atan2(pdblEndY.getValue()- pdblStartY.getValue(), 
                pdblEndX.getValue() - pdblStartX.getValue()) * 180 / 3.14;
        ...
        double dblStartX = pdblEndX.getValue() + 10 * Math.cos(angle * 3.14 * 180);
        double dblStartY = pdblEndY.getValue() + 10 * Math.sin(angle * 3.14 * 180);
        
        startXProperty().bind(new SimpleDoubleProperty(dblStartX));
        startYProperty().bind(new SimpleDoubleProperty(dblStartY));
...
//                }
                ...
                EdgeContextMenu ecmInstance = EdgeContextMenu.getInstance((EdgeLine)this.uiEdgeParent.getEdgeShape());
