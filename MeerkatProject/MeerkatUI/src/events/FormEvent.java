 ...
 *  Description     : Contains methods to construct the form event.
 *  Version         : 1.0
 *  @author         : sankalp
 * 
...
public class FormEvent {
    ...
    /**
     *  Method Name     : constructFormedEvent()
     *  Created Date    : 2017-03-23
     *  Description     : Displays formed Communities in current Time frame 
     *  Version         : 1.0
     *  @author         : sankalp
     * 
     *  EDIT HISTORY (most recent at the top)
     ...
     * 
    */
    public static void constructFormedEvent(int pintProjectID, int pintGraphID, int intTimeFrame, 
            Map<String, Integer> mapEvents, ArrayList<Map<String, List<Integer>>> arrlstCommunities, 
            List<String> lstAttributesNames, Map<Integer, Double[]> mapVertexPositions, Map<String, 
                    Color> colorMap, Set<String> userAttributes){
        ...
        for (Map.Entry<String, Integer> entry : mapEvents.entrySet()) {
            ...
            for(Integer vertexID : listSelectedVerticesIds){
                ...
                UIVertexEventProperty.addAllVertex(vertexMap.get(vertexID));
