...
/**
 *  Class Name      : JoinEvent
 *  Created Date    : 2017-03-13
 *  Description     : Contains methods to construct the join event.
 *  Version         : 1.0
 *  @author         : sankalp
 * 
...
public class JoinEvent {
    ...
    /**
     *  Method Name     : constructJoinEvent()
     *  Created Date    : 2017-03-25
     *  Description     : constructs the join event.
     *  Version         : 1.0
     *  @author         : sankalp
     * 
     * @param attrNameValuesMap
     * @param joinEventMap
     * @param colorMap
     * @param mapVertexPositions
    ...
    */
    ...
    public static void constructJoinEvent(Map<String , Map<Integer, String>> attrNameValuesMap,
            Map<String, ArrayList<String>> joinEventMap, Map<String, Color> colorMap, 
        ...
        for(Map.Entry<String, ArrayList<String>> checkentry : joinEventMap.entrySet()){
        ...
        for(Map.Entry<String, ArrayList<String>> entry : joinEventMap.entrySet()){
        ...
        // 'all' tab to show all join vertices belonging to different communities.
        Tab all = new Tab("All");
        all.setContent(vb);
        tabpRoot.getTabs().add(all);
        
        //create a tab for each community with their respective join vertices.
