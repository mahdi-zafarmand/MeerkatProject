...
/**
 *  Class Name      : LeftEvent
 *  Created Date    : 2017-03-13
 *  Description     : Contains methods to construct the left event.
 *  Version         : 1.0
 *  @author         : sankalp
 * 
...
public class LeftEvent {
    ...
    /**
     *  Method Name     : constructLeftEvent()
     *  Created Date    : 2017-03-25
     *  Description     : constructs the left event.
     *  Version         : 1.0
     *  @author         : sankalp
     * 
     *  EDIT HISTORY (most recent at the top)
    ...
    */
    ...
    public static void constructLeftEvent(Map<String , Map<Integer, String>> attrNameValuesMap,
            Map<String, ArrayList<String>> leftEventMap, Map<String, Color> colorMap, 
        ...
        for(Map.Entry<String, ArrayList<String>> checkentry : leftEventMap.entrySet()){
        ...
        for(Map.Entry<String, ArrayList<String>> entry : leftEventMap.entrySet()){
        ...
        // 'all' tab to show all left vertices belonging to different communities.
        Tab all = new Tab("All");
        all.setContent(vb);
        tabpRoot.getTabs().add(all);
        
        //create a tab for each community with their respective left vertices.
