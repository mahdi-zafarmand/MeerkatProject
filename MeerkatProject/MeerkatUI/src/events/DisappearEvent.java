...
/**
 *  Class Name      : DisappearEvent
 *  Created Date    : 2017-03-13
 *  Description     : Contains methods to construct the disappear event.
 *  Version         : 1.0
 *  @author         : sankalp
 * 
...
public class DisappearEvent {
    ...
    /**
     *  Method Name     : constructDisappearEvent()
     *  Created Date    : 2017-03-25
     *  Description     : constructs the disappear event.
     *  Version         : 1.0
     *  @author         : sankalp
     * 
     *  EDIT HISTORY (most recent at the top)
    ...
    */
    ...
    public static void constructDisappearEvent(Map<String , Map<Integer, String>> attrNameValuesMap,
            Map<String, ArrayList<String>> disappearEventMap, Map<String, Color> colorMap, 
        ...
        primaryStage.setTitle("Disappear");
        ...
        for(Map.Entry<String, ArrayList<String>> checkentry : disappearEventMap.entrySet()){
        ...
        for(Map.Entry<String, ArrayList<String>> entry : disappearEventMap.entrySet()){
        ...
        // 'all' tab to show all disappear vertices belonging to different communities.
        Tab all = new Tab("All");
        all.setContent(vb);
        tabpRoot.getTabs().add(all);
        
        //create a tab for each community with their respective disappear vertices.
