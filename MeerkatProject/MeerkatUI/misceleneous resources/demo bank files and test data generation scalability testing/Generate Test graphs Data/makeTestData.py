...
def get_edge_line(vertex_no_from, vertex_no_to, edge_weight):
    edge_line = str(vertex_no_from) + "\t" + str(vertex_no_to) + " " + "{" + "weight=" + str(edge_weight) + ";}";
    return edge_line;
...
def generate_edges(no_of_vertices, no_of_edges):
    for i in range(no_of_edges):
        ...
        edge_line  = get_edge_line(vertex_no_from, vertex_no_to, edge_weight)
...
no_of_vertices = 500000;
no_of_edges = 800000;
filename = "testdata-500k.meerkat"
